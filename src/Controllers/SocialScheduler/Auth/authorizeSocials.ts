...
export const initiateAuth = asyncHandler(async (req: CustomRequest, res: Response) => {
  try {
...
export const handleCallback = asyncHandler(async (req: CustomRequest, res: Response) => {
  try {
    ...
    const connection = await OAuthService.handleCallback(code as string, state as string);
