...
export class InstagramPoster extends BasePoster {
    ...
    try {
      ...
      if (
        ...
        return this.createResult(
          false,
          undefined,
          "No Facebook Pages found for this user. Please ensure you have page admin rights."
        );
      }
      ...
      console.log(
        ...
        JSON.stringify(igAccountResponse.data, null, 2)
      );
      ...
      const mediaResponse = await axios.post(
        `https://graph.facebook.com/${realIgAccountId}/media`,
        {
      ...
      const publishResponse = await axios.post(
        `https://graph.facebook.com/${igAccountId}/media_publish`,
        {
