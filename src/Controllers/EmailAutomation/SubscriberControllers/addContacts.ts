...
import {
  extractEmails,
  getUsersNameFromEmail,
} from "../../../Services/emailExtraction";
import { Document } from "mongoose";
import { Organization, User } from "../../../Models/User";
import { asyncHandler } from "../../../helpers/utils";
import { CustomRequest } from "../../../Types/CustomRequest";

export const addContacts = asyncHandler(
    ...
    try {
      ...
      if (!emails && !req.file)
        return resSender(
          ...
          400,
          "fail",
          "Emails addresses or email file is required"
        );
      ...
      if (contacts.length < 1)
        return resSender(res, 400, "fail", "No contacts to add");
      if (contacts.length > 1000)
        return resSender(
          res,
          400,
          "fail",
          "You can only add a maximum of 1000 contacts at a time"
        );
      ...
      return resSender(
        ...
        500,
        "error",
        error.message || "Error adding contacts"
      );
    }
  }
);
