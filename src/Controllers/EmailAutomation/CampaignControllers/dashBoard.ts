 ...
 * Get dashboard data
 */
export const getDashboardData = asyncHandler(async (req: CustomRequest, res: Response) => {
  try {
    ...
    return resSender(res, 500, 'error', error.message || 'Error fetching dashboard data');
  }
});
