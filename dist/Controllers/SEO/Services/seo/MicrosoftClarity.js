...
exports.MicrosoftClarityService = void 0;
...
class MicrosoftClarityService {
    constructor(projectId, apiKey) {
        ...
        this.httpClient = new HttpClient_1.HttpClient("https://clarity.microsoft.com", 10000, clarityHeaders);
    }
    /**
    ...
    async getSiteData(days, dimensions) {
        try {
            ...
            const clarityData2 = await axios_1.default.get("https://www.clarity.ms/export-data/api/v1/project-live-insights", {
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${this.apiKey}`
                },
...
exports.MicrosoftClarityService = MicrosoftClarityService;
