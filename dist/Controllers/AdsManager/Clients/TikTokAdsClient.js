...
exports.TikTokAdsClient = void 0;
// TikTokAdsClient.ts
const AdPlatformClient_1 = require("./AdPlatformClient");
const ads_1 = require("../../../Types/ads");
class TikTokAdsClient extends AdPlatformClient_1.AdPlatformClient {
    constructor(config) {
        super(config);
        this.platform = ads_1.AdsPlatform.TIKTOK;
    ...
    // ============= AD ACCOUNTS =============
    async getAdAccounts() {
        const response = await this.makeRequest("GET", this.getUrl("oauth2/advertiser/get/"), null, {
    ...
    async getAdAccount(accountId) {
        const response = await this.makeRequest("GET", this.getUrl("advertiser/info/"), null, {
            headers: this.getHeaders(),
    ...
    async getCampaigns(params) {
        const response = await this.makeRequest("GET", this.getUrl("campaign/get/"), null, {
            headers: this.getHeaders(),
            params: {
        ...
        return (response.data?.list || []).map((campaign) => ({
            ...
            lifetime_budget: campaign.budget_mode === "BUDGET_MODE_TOTAL"
    ...
    async getCampaign(campaignId) {
        ...
        return {
            ...
            objective: campaign.objective_type,
            status: campaign.status,
            daily_budget: campaign.budget_mode === "BUDGET_MODE_DAY"
                ? parseFloat(campaign.budget)
                : undefined,
            lifetime_budget: campaign.budget_mode === "BUDGET_MODE_TOTAL"
                ? parseFloat(campaign.budget)
    ...
    async createCampaign(params) {
        const response = await this.makeRequest("POST", this.getUrl("campaign/create/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async updateCampaign(campaignId, params) {
        ...
        await this.makeRequest("POST", this.getUrl("campaign/update/"), body, {
            headers: this.getHeaders(),
        });
        return this.getCampaign(campaignId);
    }
    async deleteCampaign(campaignId) {
        await this.makeRequest("POST", this.getUrl("campaign/update/status/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async getAdSets(campaignId, params) {
        ...
        if (params?.status)
            filtering.status = [params.status];
        const response = await this.makeRequest("GET", this.getUrl("adgroup/get/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
                page_size: params?.limit || 100,
        ...
        return (response.data?.list || []).map((adgroup) => ({
            id: adgroup.adgroup_id,
            name: adgroup.adgroup_name,
            campaign_id: adgroup.campaign_id,
            status: adgroup.status,
            daily_budget: adgroup.budget_mode === "BUDGET_MODE_DAY"
                ? parseFloat(adgroup.budget)
                : undefined,
            lifetime_budget: adgroup.budget_mode === "BUDGET_MODE_TOTAL"
                ? parseFloat(adgroup.budget)
                : undefined,
    ...
    async createAdSet(params) {
        const response = await this.makeRequest("POST", this.getUrl("adgroup/create/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async updateAdSet(adSetId, params) {
        ...
        if (params.bid_amount)
            body.bid_price = params.bid_amount;
        if (params.end_time)
            body.schedule_end_time = this.formatDateForApi(params.end_time);
        await this.makeRequest("POST", this.getUrl("adgroup/update/"), body, {
            headers: this.getHeaders(),
        });
        return this.getAdSet(adSetId);
    }
    async deleteAdSet(adSetId) {
        await this.makeRequest("POST", this.getUrl("adgroup/update/status/"), {
            advertiser_id: this.config.adAccountId,
            adgroup_ids: [adSetId],
            operation_status: "DELETE",
        }, { headers: this.getHeaders() });
    ...
    async getAds(adSetId, params) {
        ...
        if (params?.status)
            filtering.status = [params.status];
        const response = await this.makeRequest("GET", this.getUrl("ad/get/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
                page_size: params?.limit || 100,
        ...
        return (response.data?.list || []).map((ad) => ({
            id: ad.ad_id,
            name: ad.ad_name,
    ...
    async createAd(params) {
        const response = await this.makeRequest("POST", this.getUrl("ad/create/"), {
            advertiser_id: this.config.adAccountId,
            ...
            creatives: [
                {
                    ...
                    ...(params.creative && {
                        ...
                        call_to_action: params.creative.call_to_action_type || "LEARN_MORE",
    ...
    async updateAd(adId, params) {
        ...
        if (params.name)
            body.ad_name = params.name;
        if (params.status)
            body.operation_status = params.status === "ACTIVE" ? "ENABLE" : "DISABLE";
        await this.makeRequest("POST", this.getUrl("ad/update/"), body, {
            headers: this.getHeaders(),
        });
        return this.getAd(adId);
    }
    async deleteAd(adId) {
        await this.makeRequest("POST", this.getUrl("ad/update/status/"), {
            advertiser_id: this.config.adAccountId,
            ad_ids: [adId],
            operation_status: "DELETE",
        }, { headers: this.getHeaders() });
    ...
    async getCreatives(params) {
        const response = await this.makeRequest("GET", this.getUrl("creative/get/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
                page_size: params?.limit || 100,
        ...
        return (response.data?.list || []).map((creative) => ({
    ...
    async createCreative(params) {
        const response = await this.makeRequest("POST", this.getUrl("creative/create/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async updateCreative(creativeId, params) {
        ...
        if (params.name)
            body.creative_name = params.name;
        await this.makeRequest("POST", this.getUrl("creative/update/"), body, {
            headers: this.getHeaders(),
        });
        return this.getCreative(creativeId);
    }
    async deleteCreative(creativeId) {
        await this.makeRequest("POST", this.getUrl("creative/delete/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async getAudiences(params) {
        const response = await this.makeRequest("GET", this.getUrl("dmp/custom_audience/list/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
                page_size: params?.limit || 100,
        ...
        return (response.data?.list || []).map((audience) => ({
    ...
    async getAudience(audienceId) {
        const response = await this.makeRequest("GET", this.getUrl("dmp/custom_audience/get/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
    ...
    async createAudience(params) {
        const response = await this.makeRequest("POST", this.getUrl("dmp/custom_audience/create/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async updateAudience(audienceId, params) {
        ...
        if (params.name)
            body.custom_audience_name = params.name;
        await this.makeRequest("POST", this.getUrl("dmp/custom_audience/update/"), body, { headers: this.getHeaders() });
        return this.getAudience(audienceId);
    }
    async deleteAudience(audienceId) {
        await this.makeRequest("POST", this.getUrl("dmp/custom_audience/delete/"), {
            advertiser_id: this.config.adAccountId,
    ...
    async getAccountInsights(params) {
        ...
        const response = await this.makeRequest("GET", this.getUrl("report/integrated/get/"), null, {
            headers: this.getHeaders(),
            params: {
                advertiser_id: this.config.adAccountId,
    ...
    async getCampaignInsights(campaignId, params) {
        ...
        return (response.data?.list || []).map((item) => this.parseTikTokInsights(item, "campaign"));
    }
    async getAdSetInsights(adSetId, params) {
        ...
        return (response.data?.list || []).map((item) => this.parseTikTokInsights(item, "adset"));
    }
    async getAdInsights(adId, params) {
        ...
        return (response.data?.list || []).map((item) => this.parseTikTokInsights(item, "ad"));
    }
    async getInsights(params) {
        ...
        return (response.data?.list || []).map((item) => this.parseTikTokInsights(item, level));
    }
    parseTikTokInsights(item, level) {
...
exports.TikTokAdsClient = TikTokAdsClient;
